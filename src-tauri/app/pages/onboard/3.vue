...
function lastSlide2() {
    console.log('Next Slide')
    navigateTo('/onboard/2')
    
}
</script>
<template>
    <h1 class="text-center text-4xl m-4">Hi👋, Welcome to Personal Cloud</h1>
...
<span @click="nextSlide2" class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
Next</span>
</button>
</div>
</template>